...
作者：reedfan
链接：https://leetcode-cn.com/problems/convert-sorted-array-to-binary-search-tree/solution/javadi-gui-shi-xian-by-reedfan/
来源：力扣（LeetCode）
...
还记得什么是中序遍历吗？中序遍历的顺序为：根节点 \to→ 左节点 \to→ 右节点。这个遍历过程可以使用递归非常直观地进行表示。
